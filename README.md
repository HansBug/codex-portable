...
- Current documented release: [`v0.150.0`](https://github.com/HansBug/codex-portable/releases/tag/v0.150.0) published on `2026-08-27`
...
This README is pinned to the currently published release `v0.150.0`. The table below is refreshed from the actual attached release assets after the release upload job finishes.
...
These commands install the current documented release `v0.150.0` directly. If you need an older Codex version, open the Releases page and replace the fixed tag and asset names below with the older release you want.
...
- Current release: `https://github.com/HansBug/codex-portable/releases/tag/v0.150.0`
- All releases: `https://github.com/HansBug/codex-portable/releases`

### 2. Download the correct asset

Prefer `tar.gz` on Linux and macOS because it preserves executable permissions. The current release `v0.150.0` assets are already linked in the asset table above.
...
1. Extract `codex-portable-x86_64-pc-windows-msvc-v0.150.0.zip`.
...
The Linux `Fast install`, `Manual / offline install`, and `Basic config` flows for the current documented release `v0.150.0` were validated locally in clean Ubuntu-based Docker containers before publication.
