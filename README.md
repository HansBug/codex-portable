...
- Current documented release: [`v0.152.1`](https://github.com/HansBug/codex-portable/releases/tag/v0.152.1) published on `2026-09-01`
...
This README is pinned to the currently published release `v0.152.1`. The table below is refreshed from the actual attached release assets after the release upload job finishes.

| Platform | Preferred archive | Alternate archive | SHA-256 file |
| --- | --- | --- | --- |
| Linux x64 | [codex-portable-x86_64-unknown-linux-musl-v0.152.1.tar.gz](https://github.com/HansBug/codex-portable/releases/download/v0.152.1/codex-portable-x86_64-unknown-linux-musl-v0.152.1.tar.gz) | [codex-portable-x86_64-unknown-linux-musl-v0.152.1.zip](https://github.com/HansBug/codex-portable/releases/download/v0.152.1/codex-portable-x86_64-unknown-linux-musl-v0.152.1.zip) | [codex-portable-x86_64-unknown-linux-musl-v0.152.1.sha256](https://github.com/HansBug/codex-portable/releases/download/v0.152.1/codex-portable-x86_64-unknown-linux-musl-v0.152.1.sha256) |
| Linux arm64 | [codex-portable-aarch64-unknown-linux-musl-v0.152.1.tar.gz](https://github.com/HansBug/codex-portable/releases/download/v0.152.1/codex-portable-aarch64-unknown-linux-musl-v0.152.1.tar.gz) | [codex-portable-aarch64-unknown-linux-musl-v0.152.1.zip](https://github.com/HansBug/codex-portable/releases/download/v0.152.1/codex-portable-aarch64-unknown-linux-musl-v0.152.1.zip) | [codex-portable-aarch64-unknown-linux-musl-v0.152.1.sha256](https://github.com/HansBug/codex-portable/releases/download/v0.152.1/codex-portable-aarch64-unknown-linux-musl-v0.152.1.sha256) |
| macOS x64 | [codex-portable-x86_64-apple-darwin-v0.152.1.tar.gz](https://github.com/HansBug/codex-portable/releases/download/v0.152.1/codex-portable-x86_64-apple-darwin-v0.152.1.tar.gz) | [codex-portable-x86_64-apple-darwin-v0.152.1.zip](https://github.com/HansBug/codex-portable/releases/download/v0.152.1/codex-portable-x86_64-apple-darwin-v0.152.1.zip) | [codex-portable-x86_64-apple-darwin-v0.152.1.sha256](https://github.com/HansBug/codex-portable/releases/download/v0.152.1/codex-portable-x86_64-apple-darwin-v0.152.1.sha256) |
| macOS arm64 | [codex-portable-aarch64-apple-darwin-v0.152.1.tar.gz](https://github.com/HansBug/codex-portable/releases/download/v0.152.1/codex-portable-aarch64-apple-darwin-v0.152.1.tar.gz) | [codex-portable-aarch64-apple-darwin-v0.152.1.zip](https://github.com/HansBug/codex-portable/releases/download/v0.152.1/codex-portable-aarch64-apple-darwin-v0.152.1.zip) | [codex-portable-aarch64-apple-darwin-v0.152.1.sha256](https://github.com/HansBug/codex-portable/releases/download/v0.152.1/codex-portable-aarch64-apple-darwin-v0.152.1.sha256) |
| Windows x64 | [codex-portable-x86_64-pc-windows-msvc-v0.152.1.zip](https://github.com/HansBug/codex-portable/releases/download/v0.152.1/codex-portable-x86_64-pc-windows-msvc-v0.152.1.zip) | - | [codex-portable-x86_64-pc-windows-msvc-v0.152.1.sha256](https://github.com/HansBug/codex-portable/releases/download/v0.152.1/codex-portable-x86_64-pc-windows-msvc-v0.152.1.sha256) |
| Windows arm64 | [codex-portable-aarch64-pc-windows-msvc-v0.152.1.zip](https://github.com/HansBug/codex-portable/releases/download/v0.152.1/codex-portable-aarch64-pc-windows-msvc-v0.152.1.zip) | - | [codex-portable-aarch64-pc-windows-msvc-v0.152.1.sha256](https://github.com/HansBug/codex-portable/releases/download/v0.152.1/codex-portable-aarch64-pc-windows-msvc-v0.152.1.sha256) |
...
These commands install the current documented release `v0.152.1` directly. If you need an older Codex version, open the Releases page and replace the fixed tag and asset names below with the older release you want.
...
```bash
VER="v0.152.1"
ASSET="codex-portable-x86_64-unknown-linux-musl-v0.152.1.tar.gz"

touch "$HOME/.bashrc"
curl -fL -o "$ASSET" "https://github.com/HansBug/codex-portable/releases/download/$VER/$ASSET"
mkdir -p "$HOME/.local/lib"
tar -xzf "$ASSET" -C "$HOME/.local/lib"
ln -sfn "$HOME/.local/lib/codex-portable-x86_64-unknown-linux-musl-v0.152.1" "$HOME/.local/lib/codex-portable"
...
```zsh
VER="v0.152.1"
ASSET="codex-portable-aarch64-apple-darwin-v0.152.1.tar.gz"

touch "$HOME/.zshrc"
curl -fL -o "$ASSET" "https://github.com/HansBug/codex-portable/releases/download/$VER/$ASSET"
mkdir -p "$HOME/.local/lib"
tar -xzf "$ASSET" -C "$HOME/.local/lib"
ln -sfn "$HOME/.local/lib/codex-portable-aarch64-apple-darwin-v0.152.1" "$HOME/.local/lib/codex-portable"
...
```powershell
$Ver = 'v0.152.1'
$Asset = 'codex-portable-x86_64-pc-windows-msvc-v0.152.1.zip'
...
$Bundle = Join-Path $Root 'codex-portable-x86_64-pc-windows-msvc-v0.152.1'
...
```cmd
set "VER=v0.152.1"
set "ASSET=codex-portable-x86_64-pc-windows-msvc-v0.152.1.zip"
```

```cmd
powershell -NoProfile -Command "$asset='%ASSET%'; $root=Join-Path $env:LOCALAPPDATA 'Programs'; Invoke-WebRequest \"https://github.com/HansBug/codex-portable/releases/download/%VER%/$asset\" -OutFile $asset; New-Item -ItemType Directory -Force $root | Out-Null; Expand-Archive $asset -DestinationPath $root -Force; $bundle=Join-Path $root 'codex-portable-x86_64-pc-windows-msvc-v0.152.1'; $userPath=[Environment]::GetEnvironmentVariable('Path','User'); if([string]::IsNullOrWhiteSpace($userPath)){[Environment]::SetEnvironmentVariable('Path',$bundle,'User')} elseif(($userPath -split ';') -notcontains $bundle){[Environment]::SetEnvironmentVariable('Path',\"$userPath;$bundle\",'User')}; Write-Host $bundle"
```
...
- Current release: `https://github.com/HansBug/codex-portable/releases/tag/v0.152.1`
- All releases: `https://github.com/HansBug/codex-portable/releases`

### 2. Download the correct asset

Prefer `tar.gz` on Linux and macOS because it preserves executable permissions. The current release `v0.152.1` assets are already linked in the asset table above.
...
```bash
tar -xzf codex-portable-x86_64-unknown-linux-musl-v0.152.1.tar.gz
cd codex-portable-x86_64-unknown-linux-musl-v0.152.1
./codex --version
```
...
```zsh
tar -xzf codex-portable-aarch64-apple-darwin-v0.152.1.tar.gz
cd codex-portable-aarch64-apple-darwin-v0.152.1
./codex --version
```

#### Windows

1. Extract `codex-portable-x86_64-pc-windows-msvc-v0.152.1.zip`.
...
```bash
echo 'export PATH="/path/to/codex-portable-x86_64-unknown-linux-musl-v0.152.1:$PATH"' >> "$HOME/.bashrc"
export PATH="/path/to/codex-portable-x86_64-unknown-linux-musl-v0.152.1:$PATH"
```

For macOS:

```zsh
echo 'export PATH="/path/to/codex-portable-aarch64-apple-darwin-v0.152.1:$PATH"' >> "$HOME/.zshrc"
export PATH="/path/to/codex-portable-aarch64-apple-darwin-v0.152.1:$PATH"
```

On Windows, add the extracted folder in System Settings or with PowerShell:

```powershell
[Environment]::SetEnvironmentVariable('Path', "$env:Path;C:\path\to\codex-portable-x86_64-pc-windows-msvc-v0.152.1", 'User')
```
...
The Linux `Fast install`, `Manual / offline install`, and `Basic config` flows for the current documented release `v0.152.1` were validated locally in clean Ubuntu-based Docker containers before publication.
